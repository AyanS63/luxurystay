...
const EventsManagement = () => {
  ...
  const handleCreateInvoice = async (e) => {
      ...
      setProcessing(true);
      try {
          await api.post(`/events/${selectedEvent._id}/invoice`, { amount: Number(invoiceAmount) });
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto">
            ...
            <select 
              ...
              className="w-full md:w-auto px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none"
            >
