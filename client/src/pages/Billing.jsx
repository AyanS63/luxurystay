...
import { Plus, Loader, CreditCard, DollarSign, FileText } from 'lucide-react';
                ...
                >
                  ...
                  {bookings.map(booking => (
                    <option key={booking._id} value={booking._id}>
                      {booking.user?.username} - Room {booking.room?.roomNumber} ({new Date(booking.checkInDate).toLocaleDateString()})
                    </option>
                  ))}
                </select>
              </div>
