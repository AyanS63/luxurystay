    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
           <h2 className="text-4xl font-bold font-serif text-primary-700 dark:text-primary-400 mb-4">Our Accommodations</h2>
           <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Choose from our selection of premium rooms and suites, designed for your ultimate comfort and relaxation.</p>
        </div>
              ...
              <div key={room._id} className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 dark:border-slate-700 flex flex-col">
                 <div className="h-64 bg-slate-200 dark:bg-slate-700 relative overflow-hidden group">
                    {room.images && room.images.length > 0 ? (
                       ...
                       <div className="absolute inset-0 bg-slate-300 dark:bg-slate-600 flex items-center justify-center text-slate-400 dark:text-slate-500">
                          <span className="font-serif italic text-2xl opacity-50">Image Placeholder</span>
                       </div>
                    )}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl max-w-lg w-full p-8 relative overflow-hidden text-left max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-6">${selectedRoom?.pricePerNight} / night • {selectedRoom?.type}</p>
